...
@deprecated(reason="DeepImagePredictor will be removed in the next major Databricks Runtime ML "
...
@deprecated(reason="DeepImageFeaturizer will be removed in the next major Databricks Runtime ML "
                   "release. Please use Pandas UDF instead.")
